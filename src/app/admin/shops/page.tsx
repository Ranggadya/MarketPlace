...
export default function AdminShopsPage() {
  ...
  // Group shops by province
  const groupedShops = shops.reduce((acc, shop) => {
    const province = shop.province || "Lokasi Tidak Diketahui";
    if (!acc[province]) {
      acc[province] = [];
    }
    acc[province].push(shop);
    return acc;
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {Object.entries(groupedShops).map(([province, items]) => (
          <div
            key={province}
          ...
          >
            <div className="bg-red-50 px-6 py-4 border-b border-red-100 flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-gray-900">{province}</h2>
                ...
                {items.map((shop, idx) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {shop.city || "Kota tidak diketahui"}
                      </p>
                    </div>
                  </li>
                ))}
